        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-header">
                 <h5> Get connected phone information's</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="infoLogin d-none mt-5 text-center">
                        <div class="id">
                            <span class="text-danger"><b>الرقم : - </b></span>
                            <span class="numberId"></span>
                        </div>
                        <div class="name">
                            <span class="text-danger"><b>الاسم : - </b></span>
        ...
        $("#GetQrCode").on("submit",function (e) {
          ...
          $.ajax({
              ...
              success: function (data) {
                  ...
                  $(".numberId").append(`<b> ${data.id}</b>`);
                  $(".userName").append(`<b> ${data.name}</b>`);
              },
