        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-header">
                 <h5>Delete  Instant messages will be deleted (sent, queue,..)</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="{{$methods}}" method="post" enctype="application/x-www-form-urlencoded" id="GetTakeOver">
                            ...
                            <input type="hidden" class="StatusMessage" name="status" value="queue">
          ...
          $.ajax({
              ...
              success: function (data) {
                 ...
                 if(data.success == "done") {
                    alert("clearQueue Already Done Thanks");
                     // location.reload();
                 }else {
