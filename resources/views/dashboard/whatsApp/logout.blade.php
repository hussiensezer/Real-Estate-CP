        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-header">
                 <h5>Logout from WhatsApp Web to get new QR code.</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="{{$methods}}" method="post" enctype="application/x-www-form-urlencoded" id="logOut">
          ...
          $.ajax({
              ...
              success: function (data) {
                 ...
                 if(data.success == "done") {
                    alert("LogoOut Already Done Thanks");
                     location.reload();
                 }else {
